<template>
  <div id="app">
    ...
    <div id="nav" class="fake-btn">
      ...
      <router-link class="btn-fix-class" id="user-grocery-list" v-bind:to="{ name: 'user-grocery-list', params: { userID: this.$store.state.user.id } }"> MY GROCERY LIST </router-link> 
